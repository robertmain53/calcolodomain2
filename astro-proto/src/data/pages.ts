...
export const pages: PageEntry[] = [
  ...
  },
  {
    ...
    description: "Convert kilograms to pounds, highlight mass vs weight, and show planetary gravity effects.",
    primary: { hub: "Math & Science", cluster: "Conversione Unita" },
    template: "scientific",
    content: {
      intro:
      ...
      variables: ["Mass in kg or lb", "Direction (kg <-> lb)", "Gravity body selector"],
      examples: [
        "70 kg -> 154.324 lb; weight on the Moon ~ 113.4 N vs Earth ~ 686 N.",
        "150 lb -> 68.0389 kg; on Mars the same mass would weigh ~ 252 N.",
      ],
      faqs: [
        { q: "Is pound a mass or force?", a: "Pound (avoirdupois) is used for mass; pound-force is the force under standard gravity." },
        { q: "Why include gravity?", a: "It turns an ordinary converter into a quick physics lesson on mass vs weight." },
      ],
    },
  },
  {
    ...
    description: "Convert centimeters to inches with fractional output, feet+inches helper, and visual ruler.",
    primary: { hub: "Math & Science", cluster: "Conversione Unita" },
    template: "visual",
    content: {
      intro:
      ...
      faqs: [
        { q: "Why show fractions?", a: "Imperial plans and tape measures use fractions; this bridges them with metric inputs." },
        { q: "Can I switch to feet+inches?", a: "Use the helper to express decimal inches as ft+in for quick readability." },
      ],
    },
  },
  {
    ...
    description: "Convert pounds to kilograms with imperial context, slug unit mention, and gravity insights.",
    primary: { hub: "Math & Science", cluster: "Conversione Unita" },
    template: "scientific",
    content: {
      intro:
      ...
      variables: ["Mass in lb or kg", "Direction (lb <-> kg)", "Gravity selector"],
      examples: [
      ...
      faqs: [
        { q: "What is a slug?", a: "A slug is the imperial mass unit where 1 slug = 32.174 lb; it keeps F=ma consistent in imperial equations." },
        { q: "Who still uses pounds?", a: "Primarily the US and parts of the UK/Canada; SI kilograms are standard in science and trade elsewhere." },
      ],
    },
  },
  {
    ...
    description: "Convert BTU <-> kWh with clear separation of energy vs power and HVAC-ready examples.",
    primary: { hub: "Engineering & Construction", cluster: "Termotecnica & HVAC" },
    ...
    content: {
      ...
      variables: ["Energy value", "Direction (BTU <-> kWh)", "Significant figures"],
      examples: [
      ...
      faqs: [
        { q: "BTU or BTU/h?", a: "BTU is energy; BTU/h is power. This tool converts energy-size equipment with BTU/h or kW separately." },
        { q: "Where does 3412 come from?", a: "It ties the joule definition to the mechanical equivalent of heat linking watt-hours and BTU." },
      ],
    },
  },
  {
    ...
    description: "Convert A <-> nm with scientific notation for spectroscopy, crystallography, and nano-tech.",
    primary: { hub: "Math & Science", cluster: "Conversione Unita" },
    template: "scientific",
    content: {
      intro:
      ...
      variables: ["Value", "Direction (A <-> nm)", "Scientific notation output", "Significant figures"],
      examples: [
        "1.54 A (C-C bond) = 0.154 nm.",
        "550 nm (green light) = 5500 A; a 3 A lattice spacing = 0.3 nm.",
      ],
      faqs: [
        { q: "Why still use A?", a: "A is common shorthand in crystallography and spectroscopy; nm is SI-preferred for publication." },
        { q: "Can I trust sci-notation output?", a: "Yes-use it to keep numbers readable while retaining magnitude and sig figs." },
      ],
    },
  },
  {
    ...
    description: "Convert K <-> F with zero-absolute context, combined formula, and scale comparisons.",
    primary: { hub: "Math & Science", cluster: "Conversione Unita" },
    template: "visual",
    content: {
      intro:
      ...
      faqs: [
        { q: "Why Kelvin instead of Celsius?", a: "Absolute temperatures make thermodynamic equations valid (ideal gas law, entropy, black-body radiation)." },
        { q: "What is absolute zero?", a: "0 K is the theoretical minimum thermal energy; particles have minimal motion." },
      ],
    },
  },
  {
    ...
    description: "Convert degrees <-> radians with a unit-circle visual, pi multiples, and trig outputs.",
    primary: { hub: "Math & Science", cluster: "Conversione Unita" },
    template: "visual",
    content: {
      intro:
      ...
      faqs: [
        { q: "Why use radians?", a: "They are the natural angle unit for calculus, physics, and engineering formulas." },
        { q: "How to express in pi form?", a: "Divide by pi to see multiples (e.g., pi/6, pi/4, pi/3) and reduce fractions." },
      ],
    },
  },
  {
    ...
    content: {
      ...
      variables: ["System selection", "Value", "Direction (cups <-> tbsp)", "Milliliter output"],
      examples: [
        "1 US cup -> 16 US tbsp -> 236.59 mL (sauces, stock).",
        "4 tbsp (metric) -> 0.24 metric cup ~ 60 mL; 2 imperial tbsp -> ~1/8 imperial cup.",
      ],
      faqs: [
        { q: "Which standard do you use?", a: "Pick US customary/legal, metric, or imperial to avoid regional mismatches." },
        { q: "Dry vs liquid?", a: "Use weight (grams) for flour/sugar; volume is accurate for liquids and thin batters." },
        { q: "Can I convert to teaspoons or ounces?", a: "Use the standards table to infer tsp and fl oz; stick to one system per recipe." },
      ],
    },
  },
];
