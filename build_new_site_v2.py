...
print("AVVIO SCRIPT DI RICOSTRUZIONE TOTALE DA ZERO (v4.1 - Corretto)")
...
# --- 3. ESECUZIONE PRINCIPALE (LA FABBRICA v4.1) ---
def main():
    ...
    for url_path, content in content_data.items():
        ...
        try:
            # Ricostruisci il path relativo per il controllo
            if url_path == "/":
                relative_path = "index.html"
            else:
                relative_path = url_path[1:] + ".html"
            
            # --- NUOVA LOGICA: LISTA DI IGNORATI ---
            ...
            # Aggiungi i vecchi schemi FAQ/HowTo che abbiamo estratto
            if content['old_schemas']:
