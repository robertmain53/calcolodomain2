...
## Attach sitemap_data_FINAL_flat.json
...
<head>
    ...
    <style>
        ...
        /* Stili per il contenuto estratto (es. .prose per articoli) */
...
In allegato trovi il mio sitemap_data_FINAL_flat.json. Contiene la struttura di navigazione, le categorie e le sottocategorie di TUTTE le pagine. Lo userai per generare dinamicamente le BREADCRUMB e la SIDEBAR.
...
1.  **Target (URL Piatto):** /nome-pagina

2.  **Parola Chiave Principale:** Nome Calcolatore
...
Lascia i segnaposto per gli script (%%HEAD_SCRIPTS...%%) così come sono, li inserirò io.

Consegnare: Forniscimi il singolo file HTML completo in un blocco di codice.

Per favore, conferma di aver ricevuto e compreso questi 3 Asset e questo flusso di lavoro. Poi  per i prossimi calcolatori ricorda che %%BODY_SCRIPTS_INIZIO%% = 
...
2.  **Parola Chiave Principale:** matrix inverse
3.  **Obiettivo Principale dello Strumento:** matrix inverse
4.  **Concorrenti da Analizzare e Superare: **
   * https://it.wikipedia.org/wiki/Matrice_invertibile 
   * https://en.wikipedia.org/wiki/Invertible_matrix 
   * https://matrix.reshish.com/inverse-matrix/ 
   * https://mathworld.wolfram.com/MatrixInverse.html 
   * https://www.mathsisfun.com/algebra/matrix-inverse.html 
   * https://www.youtube.com/watch?v=p0eyU0uYdrM 
